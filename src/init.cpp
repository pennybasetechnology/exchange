        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Bitcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  ...
                  "  bitcond [options] help                " + _("List commands") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 18332)") + "\n" +
...
#endif
        "  -rpcuser=<user>        " + _("Username for JSON-RPC connections <user> (default: test)") + "\n" +
        "  -rpcpassword=<pw>      " + _("Password for JSON-RPC connections <pw> (default: test)") + "\n" +
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 18332)") + "\n" +
